...
//--- Generic.
missionNamespace setVariable [Format["WF_%1WHEELEDCREW", _side], 'rhsusf_army_ucp_arb_rifleman'];
...
missionNamespace setVariable [Format["WF_%1SOLDIER", _side], 'rhsusf_army_ucp_arb_rifleman'];
...
missionNamespace setVariable [Format["WF_%1REPAIRTRUCKS", _side], ['rhsusf_M977A4_REPAIR_BKIT_M2_usarmy_d','rhsusf_M977A4_REPAIR_usarmy_d','rhsusf_M977A4_REPAIR_BKIT_usarmy_d']];
...
missionNamespace setVariable [Format["WF_%1STARTINGVEHICLES", _side], ['CUP_B_HMMWV_Ambulance_USA','rhsusf_M1078A1P2_B_d_fmtv_usarmy']];//--- Starting Vehicles.
...
if ((missionNamespace getVariable "WF_C_BASE_PATROLS_INFANTRY") > 0) then {
	missionNamespace setVariable [Format["WF_%1BASEPATROLS_0", _side],['rhsusf_army_ucp_arb_squadleader','rhsusf_army_ucp_arb_rifleman','rhsusf_army_ucp_arb_rifleman','rhsusf_army_ucp_arb_grenadier','rhsusf_army_ucp_arb_grenadier','rhsusf_army_ucp_rifleman_arb_m16']];
	missionNamespace setVariable [Format["WF_%1BASEPATROLS_1", _side],['rhsusf_army_ucp_arb_squadleader','rhsusf_army_ucp_arb_medic','rhsusf_army_ucp_arb_rifleman','rhsusf_army_ucp_arb_autoriflemana','rhsusf_army_ucp_arb_machinegunnera','rhsusf_army_ucp_arb_engineer']];
	missionNamespace setVariable [Format["WF_%1BASEPATROLS_2", _side],['rhsusf_army_ucp_arb_squadleader','rhsusf_army_ucp_arb_rifleman','rhsusf_army_ucp_arb_machinegunnera','rhsusf_army_ucp_arb_riflemanat','rhsusf_army_ucp_arb_riflemanat','rhsusf_army_ucp_sniper']];
	missionNamespace setVariable [Format["WF_%1BASEPATROLS_3", _side],['rhsusf_army_ucp_arb_squadleader','rhsusf_army_ucp_aa','rhsusf_army_ucp_arb_machinegunnera','rhsusf_army_ucp_javelin','rhsusf_army_ucp_arb_riflemanat','rhsusf_army_ucp_arb_grenadier']];
	missionNamespace setVariable [Format["WF_%1BASEPATROLS_4", _side],['rhsusf_army_ucp_arb_squadleader','rhsusf_army_ucp_aa','rhsusf_army_ucp_arb_machinegunnera','rhsusf_army_ucp_javelin','rhsusf_army_ucp_arb_riflemanat','rhsusf_army_ucp_arb_grenadier']];
};
...
missionNamespace setVariable ["WF_WEST_DefaultGearEngineer", [
		...
		[
			["rhs_uniform_acu_ucp",["FirstAidKit","FirstAidKit","FirstAidKit","rhs_mag_m67","rhs_mag_m67"]],
			["rhsusf_spcs_ucp",["CUP_100Rnd_556x45_BetaCMag","CUP_100Rnd_556x45_BetaCMag","rhsusf_mag_17Rnd_9x19_JHP","rhsusf_mag_17Rnd_9x19_JHP","CUP_100Rnd_556x45_BetaCMag","CUP_100Rnd_556x45_BetaCMag"]],
			["rhsusf_assault_eagleaiii_ucp",["CUP_100Rnd_556x45_BetaCMag","CUP_100Rnd_556x45_BetaCMag","CUP_100Rnd_556x45_BetaCMag"]]
		],
...
missionNamespace setVariable ["WF_WEST_DefaultGearSpot", [
		...
		[
			...
			["rhsusf_spcs_ucp",["CUP_10x_303_M","CUP_10x_303_M","CUP_10x_303_M","CUP_10x_303_M","CUP_10x_303_M","CUP_10x_303_M","CUP_32Rnd_9x19_TEC9","CUP_32Rnd_9x19_TEC9"]],
			["",[""]]
		],
...
missionNamespace setVariable ["WF_WEST_DefaultGearSoldier", [
		...
		[
			["rhs_uniform_acu_ucp",["FirstAidKit","FirstAidKit","FirstAidKit","rhs_mag_m67","rhs_mag_m67"]],
			["rhsusf_spcs_ucp",["rhs_mag_M441_HE","rhs_mag_M441_HE","rhs_mag_M441_HE","rhs_mag_M441_HE","rhs_mag_M441_HE","rhs_mag_M441_HE","rhs_mag_M441_HE","rhs_mag_30Rnd_556x45_Mk318_Stanag","rhs_mag_30Rnd_556x45_Mk318_Stanag","rhs_mag_30Rnd_556x45_Mk318_Stanag","rhs_mag_30Rnd_556x45_Mk318_Stanag","rhs_mag_30Rnd_556x45_Mk318_Stanag","rhs_mag_30Rnd_556x45_Mk318_Stanag""rhsusf_mag_17Rnd_9x19_JHP","rhsusf_mag_17Rnd_9x19_JHP"]],
			["rhsusf_assault_eagleaiii_ucp",["FirstAidKit"]]
		],
...
missionNamespace setVariable ["WF_WEST_DefaultGearLock", [
		...
		[
			["rhs_uniform_acu_ucp",["FirstAidKit","FirstAidKit","FirstAidKit","rhs_mag_m67","rhs_mag_m67"]],
			["rhsusf_spcs_ucp",["rhs_mag_30Rnd_556x45_Mk318_Stanag","rhs_mag_30Rnd_556x45_Mk318_Stanag","rhs_mag_30Rnd_556x45_Mk318_Stanag","rhs_mag_30Rnd_556x45_Mk318_Stanag","rhs_mag_30Rnd_556x45_Mk318_Stanag","rhs_mag_30Rnd_556x45_Mk318_Stanag","rhsusf_mag_17Rnd_9x19_JHP","rhsusf_mag_17Rnd_9x19_JHP"]],
			["rhsusf_assault_eagleaiii_ucp",["FirstAidKit"]]
		],
...
missionNamespace setVariable ["WF_WEST_DefaultGearUAVOperator", [
		...
		[
			["rhs_uniform_acu_ucp",["FirstAidKit","FirstAidKit","FirstAidKit","rhs_mag_m67","rhs_mag_m67"]],
			["rhsusf_spcs_ucp",["rhssaf_30Rnd_556x45_EPR_G36","rhssaf_30Rnd_556x45_EPR_G36","rhssaf_30Rnd_556x45_EPR_G36","rhssaf_30Rnd_556x45_EPR_G36","rhssaf_30Rnd_556x45_EPR_G36","rhssaf_30Rnd_556x45_EPR_G36","rhsusf_mag_17Rnd_9x19_JHP","rhsusf_mag_17Rnd_9x19_JHP"]],
