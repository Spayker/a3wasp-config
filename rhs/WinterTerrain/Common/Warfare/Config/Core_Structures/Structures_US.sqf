...
_n pushBack "Land_BagFenceLong";
_n pushBack "Land_BagFenceRound";
_n pushBack "Land_BagFenceCorner";
...
missionNamespace setVariable [Format["WF_%1DEFENSES_MG", _side], ["RHS_M2StaticMG_D"]];
missionNamespace setVariable [Format["WF_%1DEFENSES_GL", _side], ["RHS_MK19_TriPod_D"]];
missionNamespace setVariable [Format["WF_%1DEFENSES_AAPOD", _side], ["RHS_Stinger_AA_pod_D"]];
