...
/* Root Definition */
_MHQ = "O_APC_Wheeled_02_rcws_v2_F";
_HQ = "O_APC_Tracked_02_cannon_F";
...
_env		= [[["Land_Sacks_heap_F",[1.4248,0.0610352,0],0,1,0,[],"","",true,false], 
	...
	["O_APC_Tracked_02_cannon_F",[-1.38184,1.9209,10000],270.382,1,0,[],"","",true,false], 
...
_dmgbl 		= [["O_APC_Tracked_02_cannon_F"]];
_dmgr = [[12]];
...
_env pushBack [["Land_HBarrier_3_F",[0.0727539,2.0249,0],270,1,0,[],"","",true,false], 
	...
	["O_Truck_03_transport_F",[-6.67383,3.42529,10000.00151062],49.1788,1,0,[],"","",true,false],
...
_dmgbl pushBack ["Land_Cargo_Patrol_V3_F", "O_Truck_03_transport_F"];
...
_env pushBack [["Land_Cargo_HQ_V3_F",[0.728027,1.44531,0],21.9901,1,0,[],"","",true,false], 
	...
	["O_MBT_02_cannon_F",[-3.86865,-10.1255,10000],322.691,1,0,[],"","",true,false], 
...
_dmgbl pushBack ["Land_Cargo_HQ_V3_F", "Land_Cargo_House_V3_F", "O_MBT_02_cannon_F"];
...
_env pushBack [["B_Slingload_01_Repair_F",[1.80469,-0.0795898,10000],360,1,0,[],"","",true,false], 
	...
	["O_Heli_Light_02_unarmed_F",[-3.37305,-4.67871,9999.874419],102.847,1,0,[],"","",true,false], 
...
_dmgbl 	pushBack ["B_Slingload_01_Repair_F", "B_Slingload_01_Fuel_F", "O_Heli_Light_02_unarmed_F"];
...
_dmgbl pushBack ["Land_TTowerSmall_1_F", "Land_TTowerSmall_2_F", "Land_Cargo_House_V3_F"];
_dmgr pushBack [2, 2, 1];
_smpl pushBack [];
...
// static defence
_n =         ["O_Mortar_01_F"];
_n pushBack "O_HMG_01_F";
_n pushBack "O_HMG_01_high_F";
_n pushBack "O_GMG_01_F";
_n pushBack "O_GMG_01_high_F";
_n pushBack "O_Static_Designator_02_F";
_n pushBack "O_HMG_01_A_F";
_n pushBack "O_GMG_01_A_F";
_n pushBack "O_static_AT_F";
...
// static ammo
_n pushBack "O_supplyCrate_F";
_n pushBack "Box_CSAT_Equip_F";
_n pushBack "Box_East_WpsSpecial_F";
_n pushBack "Box_East_WpsLaunch_F";
_n pushBack "Box_East_Support_F";
_n pushBack "Box_East_Ammo_F";
_n pushBack "Box_East_Wps_F";
_n pushBack "Box_East_Grenades_F";
_n pushBack "Box_CSAT_Uniforms_F";
_n pushBack "Box_East_AmmoOrd_F";

//_n pushBack "GUE_WarfareBVehicleServicePoint";

/* Class used for AI, AI will attempt to build those */
missionNamespace setVariable [Format["WF_%1DEFENSES_MG", _side], ['O_HMG_01_high_F']];
missionNamespace setVariable [Format["WF_%1DEFENSES_GL", _side], ['O_GMG_01_high_F']];
missionNamespace setVariable [Format["WF_%1DEFENSES_AAPOD", _side], ['O_static_AA_F','O_SAM_System_04_F']];
missionNamespace setVariable [Format["WF_%1DEFENSES_ATPOD", _side], ['O_static_AT_F']];
missionNamespace setVariable [Format["WF_%1DEFENSES_MASH", _side], ['MASH']];
missionNamespace setVariable [Format["WF_%1DEFENSES_MORTAR", _side], ['O_Mortar_01_F']];
