...
/* Root Definition */
_MHQ = 'B_APC_Wheeled_01_cannon_F';
_HQ = "B_AFV_Wheeled_01_cannon_F";
...
_env		= [[["Land_Garbage_square5_F",[1.49756,-0.345703,0],0,1,0,[],"","",true,false], 
	["B_AFV_Wheeled_01_cannon_F",[-1.6748,-1.95459,10000],272.882,1,0,[],"","",true,false], 
...
_dmgbl 		= [["B_AFV_Wheeled_01_cannon_F"]];
_dmgr = [[12]];
_smpl 		= [["CamoNet_BLUFOR_F"]];
...
_env pushBack [["Land_HBarrier_3_F",[2.6001,1.71924,0],90,1,0,[],"","",true,false], 
	...
	["B_Truck_01_transport_F",[-5.52441,5.57617,10000],75.5549,1,0,[],"","",true,false], 
...
_dmgbl 	pushBack ["Land_Cargo_Patrol_V1_F", "B_Truck_01_transport_F"];
...
_dis pushBack 45;
_dir pushBack 0;
_env	pushBack [["Land_Cargo_HQ_V1_F",[-1.1665,1.62891,0],356.199,1,0,[],"","",true,false], 
	...
	["CargoNet_01_barrels_F",[0.333984,-13.458,0],21.6589,1,0,[],"","",true,false], 
	["B_MBT_01_cannon_F",[-9.73096,-8.60596,10000],0,1,0,[],"","",true,false], 
	...
	["CamoNet_BLUFOR_open_F",[-13.5767,-7.61426,0],89.2639,1,0,[],"","",true,false], 
	...
	["Land_Cargo_House_V1_F",[-5.34717,-16.811,0],0,1,0,[],"","",true,false], 
	["Land_BagFence_Round_F",[-12.0645,-14.8906,-0.00130129],24.5494,1,0,[],"","",true,false]];
_dmgbl 	pushBack ["Land_Cargo_HQ_V1_F", "Land_Cargo_House_V1_F", "B_MBT_01_cannon_F"];
_dmgr pushBack [0.25, 2, 10];
_smpl pushBack ["CamoNet_BLUFOR_open_F"];
...
_env pushBack [["B_Slingload_01_Repair_F",[1.80469,-0.0795898,10000],360,1,0,[],"","",true,false], 
	...
	["B_Heli_Transport_01_F",[-5.1123,-4.01611,10000.054111],104.504,1,0,[],"","",true,false], 
...
_dmgbl 	pushBack ["B_Slingload_01_Repair_F", "B_Slingload_01_Fuel_F", "B_Heli_Transport_01_F"];
...
// static defence
_n =         ["B_Mortar_01_F"];
_n pushBack "B_HMG_01_F";
_n pushBack "B_HMG_01_high_F";
_n pushBack "B_GMG_01_F";
_n pushBack "B_GMG_01_high_F";
_n pushBack "B_Static_Designator_01_F";
_n pushBack "B_HMG_01_A_F";
_n pushBack "B_GMG_01_A_F";
_n pushBack "B_static_AT_F";
_n pushBack "B_static_AA_F";
...
_n pushBack "Land_DragonsTeeth_01_4x2_old_F";
_n pushBack "Land_Razorwire_F";

// static ammo
_n pushBack "B_supplyCrate_F";
_n pushBack "Box_NATO_Equip_F";
_n pushBack "Box_NATO_WpsSpecial_F";
_n pushBack "Box_NATO_WpsLaunch_F";
_n pushBack "Box_NATO_Support_F";
_n pushBack "Box_NATO_Ammo_F";
_n pushBack "Box_NATO_Wps_F";
_n pushBack "Box_NATO_Grenades_F";
_n pushBack "Box_NATO_Uniforms_F";
_n pushBack "Box_NATO_AmmoOrd_F";
//_n pushBack "GUE_WarfareBVehicleServicePoint";


/* Class used for AI, AI will attempt to build those */
missionNamespace setVariable [Format["WF_%1DEFENSES_MG", _side], ['B_HMG_01_high_F']];
missionNamespace setVariable [Format["WF_%1DEFENSES_GL", _side], ['B_GMG_01_high_F']];
missionNamespace setVariable [Format["WF_%1DEFENSES_AAPOD", _side], ['B_static_AA_F','B_SAM_System_02_F','B_SAM_System_03_F']];
missionNamespace setVariable [Format["WF_%1DEFENSES_ATPOD", _side], ['B_static_AT_F']];
missionNamespace setVariable [Format["WF_%1DEFENSES_MASH", _side], ['MASH']];
missionNamespace setVariable [Format["WF_%1DEFENSES_MORTAR", _side], ['B_Mortar_01_F']];
