...
_env pushBack [["Land_Cargo_HQ_V1_F",[-1.1665,1.62891,10000],356.199,1,0,[],"","",true,false],
	...
	["CUP_B_M270_HE_USA",[-9.73096,-8.60596,10000],0,1,0,[],"","",true,false],
...
_dmgbl 	pushBack ["Land_Cargo_HQ_V1_F", "Land_Cargo_House_V1_F", "CUP_B_M270_HE_USA"];
...
missionNamespace setVariable [Format["WF_%1DEFENSES_MORTAR", _side], ["CUP_B_M252_US"]];
