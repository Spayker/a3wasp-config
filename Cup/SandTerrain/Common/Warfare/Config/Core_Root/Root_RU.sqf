...
missionNamespace setVariable [Format["WF_%1ENGINEER", _side], 'CUP_O_RU_Engineer_Ratnik_BeigeDigital'];
...
if ((missionNamespace getVariable "WF_C_BASE_PATROLS_INFANTRY") > 0) then {
	...
	missionNamespace setVariable [Format["WF_%1BASEPATROLS_1", _side],['CUP_O_RU_Soldier_SL_Ratnik_BeigeDigital','CUP_O_RU_Medic_Ratnik_BeigeDigital','CUP_O_RU_Soldier_Ratnik_BeigeDigital','CUP_O_RU_Soldier_AR_Ratnik_BeigeDigital','','CUP_O_RU_Engineer_Ratnik_BeigeDigital']];
