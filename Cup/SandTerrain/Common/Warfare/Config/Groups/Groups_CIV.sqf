...
_k pushBack "Squad_0";
_u		= ["CUP_B_CDF_Officer_FST"];
_u pushBack "CUP_B_CDF_Soldier_MG_FST";
_u pushBack "CUP_B_CDF_Engineer_FST";
_u pushBack "CUP_B_CDF_Militia_FST";
_u pushBack "CUP_B_CDF_Soldier_GL_FST";
_u pushBack "CUP_B_CDF_Soldier_LAT_FST";
_u pushBack "CUP_B_CDF_Medic_FST";
_l pushBack _u;

_k pushBack "Squad_1";
_u		= ["CUP_B_CDF_Soldier_TL_FST"];
_u pushBack "CUP_B_CDF_Soldier_MG_FST";
_u pushBack "CUP_B_CDF_Soldier_LAT_FST";
_u pushBack "CUP_B_CDF_Soldier_AR_FST";
_u pushBack "CUP_B_CDF_Soldier_GL_FST";
_u pushBack "CUP_B_CDF_Soldier_RPG18_FST";
_u pushBack "CUP_B_CDF_Soldier_RPG18_FST";
_l pushBack _u;
...
_u		= ["CUP_B_CDF_Soldier_TL_FST"];
_u pushBack "CUP_B_CDF_Soldier_MG_FST";
_u pushBack "CUP_B_CDF_Soldier_AMG_FST";
_u pushBack "CUP_B_CDF_Soldier_AR_FST";
_u pushBack "CUP_B_CDF_Soldier_GL_FST";
_u pushBack "CUP_I_PMC_Bodyguard_M4";
_u pushBack "CUP_B_CDF_Soldier_AAT_FST";
_l pushBack _u;
...
_u =  ["CUP_B_CDF_Soldier_RPG18_FST"];
...
_k pushBack "Team_AA";
_u		= ["CUP_B_CDF_Soldier_AA_FST"];
_u pushBack "CUP_B_CDF_Soldier_AA_FST";
_u pushBack "CUP_I_PMC_Soldier_AA";
_l pushBack _u;

_k pushBack "Team_Sniper_0";
_u		= ["CUP_B_CDF_Sniper_FST"];
_u pushBack "CUP_B_CDF_Sniper_FST";
_u pushBack "CUP_B_CDF_Spotter_FST";
_l pushBack _u;

_k pushBack "Team_Sniper_1";
_u		= ["CUP_B_CDF_Soldier_Marksman_FST"];
